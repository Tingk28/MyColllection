<?php
    ...
    //there is to way to connect, connect to localhost or google cloud sql
    function get_db(){
        if($_SERVER['HTTP_HOST'] == "localhost"){
            //$servername = "35.236.171.191"; // for cloud SQL
